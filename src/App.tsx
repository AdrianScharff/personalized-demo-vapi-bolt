...
const vapi = new Vapi('729d9c1b-0800-46ce-81ca-1a947525f77d');
...
function App() {
  ...
  const handleBrowserTest = async () => {
    try {
      ...
      if (isCalling) {
        ...
        await vapi.start('4b03bf21-74fa-43db-af5f-86564ff2cf63', assistantOverrides);
      }
    } catch (error) {
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 flex items-center justify-center">
        <div className="text-center space-y-8 max-w-md mx-auto px-6">
          ...
          <div className="space-y-4">
            <h1 className="text-4xl font-bold text-slate-900 font-antonio">Page Not Found</h1>
            <p className="text-xl text-slate-600 font-dm-sans">The requested page does not exist.</p>
          </div>
          <a
            href="<My_Website_URL>"
            className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-emerald-600 to-teal-600 text-white rounded-2xl font-semibold hover:from-emerald-700 hover:to-teal-700 transition-all duration-300 shadow-lg shadow-emerald-600/25 hover:shadow-xl hover:shadow-emerald-600/30 transform hover:-translate-y-0.5"
          >
            <Globe size={20} />
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 font-dm-sans">
      <div className="relative overflow-hidden min-h-screen">
        ...
        <div className="absolute bottom-20 right-10 w-96 h-96 bg-gradient-to-br from-violet-200/30 to-purple-200/30 rounded-full blur-3xl"></div>
        
        <div className="relative max-w-7xl mx-auto px-4 pt-20 pb-32 sm:px-6 lg:px-8 text-center">
          <div className="space-y-12 max-w-4xl mx-auto">
            <div className="space-y-6">
              <h1 className="text-6xl md:text-7xl font-bold leading-tight text-slate-900 font-sora">
                Hey{' '}
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center max-w-lg mx-auto">
              <button
                ...
                className={`group w-full sm:w-1/2 px-8 py-5 bg-gradient-to-r from-emerald-600 to-teal-600 text-white rounded-2xl font-semibold flex items-center justify-center gap-3 hover:from-emerald-700 hover:to-teal-700 transition-all duration-300 shadow-lg shadow-emerald-600/25 hover:shadow-xl hover:shadow-emerald-600/30 transform hover:-translate-y-0.5 ${showPhoneForm ? 'ring-2 ring-emerald-500 ring-offset-2' : ''}`}
              >
              ...
              <div className="animate-fade-in">
                <form onSubmit={handleSubmit} className="max-w-md mx-auto space-y-6 bg-white/70 backdrop-blur-sm rounded-3xl p-8 shadow-xl shadow-slate-200/50 border border-white/50">
                  <div className="space-y-4">
                    ...
                    {success && (
                      <div className="flex items-center gap-2 text-emerald-700 text-sm font-medium bg-emerald-50 px-4 py-3 rounded-xl border border-emerald-200">
                    ...
                    <button
                      type="submit"
                      disabled={isSubmitting}
                      className="group w-full px-8 py-4 bg-gradient-to-r from-emerald-600 to-teal-600 text-white rounded-2xl font-semibold flex items-center justify-center gap-3 hover:from-emerald-700 hover:to-teal-700 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-emerald-600/25 hover:shadow-xl hover:shadow-emerald-600/30 transform hover:-translate-y-0.5 disabled:transform-none"
                    >
        ...
        <footer className="absolute bottom-0 left-0 right-0 p-8">
          <div className="max-w-7xl mx-auto flex justify-center items-center space-x-8">
            <a 
              ...
              className="group text-slate-500 hover:text-emerald-600 transition-all duration-300 flex items-center gap-2 bg-white/50 backdrop-blur-sm px-4 py-2 rounded-xl hover:bg-white/80 hover:shadow-lg hover:shadow-slate-200/50"
            >
